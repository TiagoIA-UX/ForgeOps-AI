    ...
    return (
      <div className="min-h-screen bg-zaea-bg flex items-center justify-center p-4">
        <div className="w-full max-w-md text-center space-y-4">
          <CheckCircle size={48} className="text-zaea-success mx-auto" />
          ...
          <Link href="/auth/login" className="text-sm text-zaea-accent hover:underline">
            Voltar ao login
          </Link>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-zaea-bg flex items-center justify-center p-4">
      <div className="w-full max-w-md space-y-6">
        <div className="text-center space-y-2">
          <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-zaea-accent/20 border border-zaea-accent/30">
            <Zap size={24} className="text-zaea-accent" />
          </div>
          <h1 className="text-2xl font-bold text-white">Criar conta grátis</h1>
          <p className="text-sm text-zaea-muted">1 repo, monitoramento a cada hora</p>
        </div>
        ...
        <div className="bg-zaea-surface border border-zaea-border rounded-xl p-6 space-y-5">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-zaea-border hover:border-zaea-accent/50 rounded-lg text-sm font-medium text-white transition-colors disabled:opacity-50"
          >
          ...
          <div className="relative">
            <div className="absolute inset-0 flex items-center">
              <div className="w-full border-t border-zaea-border" />
            </div>
            <div className="relative text-center">
              <span className="bg-zaea-surface px-3 text-xs text-zaea-muted">ou com e-mail</span>
            </div>
          </div>

          <form onSubmit={handleSignup} className="space-y-4">
            <div>
              <label className="block text-xs font-medium text-zaea-muted mb-1.5">Nome</label>
              <input
                type="text"
                required
                value={name}
            ...
            <div>
              <label className="block text-xs font-medium text-zaea-muted mb-1.5">E-mail</label>
              <input
                type="email"
                required
                value={email}
            ...
            <div>
              <label className="block text-xs font-medium text-zaea-muted mb-1.5">Senha</label>
              <input
                type="password"
                required
                minLength={8}
        ...
        <p className="text-center text-xs text-zaea-muted">
          Já tem conta?{" "}
          <Link href="/auth/login" className="text-zaea-accent hover:underline">
            Entrar
          </Link>
        </p>
      </div>
